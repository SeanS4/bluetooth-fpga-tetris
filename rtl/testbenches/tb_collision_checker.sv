...
module tb_collision_checker;
    ...
    logic [3:0][3:0] new_shape_matrix; // Not used directly (handled inside DUT through shape_rom)
    ...
    initial begin
        ...
        // ==============================================
        run_test(18, 5, 3'd6, 2'd0, "Rotate T shape safely (no collision)");
        run_test(17, 6, 3'd5, 2'd1, "Rotate L shape safely");

        // ==============================================
        // Rotation Tests - EXPECT COLLISION (Invalid Rotations)
        // ==============================================
        run_test(23, 5, 3'd6, 2'd1, "Rotate T shape into right wall (collision)");
        run_test(18, 7, 3'd5, 2'd1, "Rotate L shape into occupied block (collision)");
